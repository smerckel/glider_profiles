'''Splitting glider data into profiles

This module provides functionality to split glider time series into
profile data. This can be done as complete casts (a single down and
subsequent up cast), downcasts only, or upcasts only.
